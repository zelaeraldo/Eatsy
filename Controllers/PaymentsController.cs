...
namespace Eatsy1.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,PaymentMethod,PaymentDate,Amount,IsSuccessful")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderId,PaymentMethod,PaymentDate,Amount,IsSuccessful")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
